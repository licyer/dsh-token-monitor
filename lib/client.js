	...
	factory: (require) => {
		...
		var DICT = {
			zh: {
				...
				"settings.pricing.colCreate": "缓存创建",
			...
			en: {
				...
				"src.col.lastUpdate": "Last update",
				...
				"settings.pricing.colCreate": "Cache create",
		...
		/** 数据来源卡"上次更新"：yyyy-MM-dd HH:mm:ss；无记录显示 —。 */
						...
						h("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: "12px", tableLayout: "fixed" } },
							h("thead", null,
								h("tr", null,
									...
									h("th", { style: Object.assign({}, S.usageTh, { width: "33%" }) }, t("src.col.desc")),
									h("th", { style: Object.assign({}, S.usageTh, { width: "25%" }) }, t("src.col.dir")),
									h("th", { style: Object.assign({}, S.usageTh, { width: "14%" }) }, t("src.col.lastUpdate")),
									h("th", { style: Object.assign({}, S.usageTh, { width: "18%" }) }, t("src.col.action")))),
							h("tbody", null,
								h("tr", null,
									...
									h("td", { style: Object.assign({}, S.usageTd, { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }), title: fmtLastUpd(sources && sources.lastUpdated ? sources.lastUpdated["dsh-logs"] : null) },
								...
								h("tr", null,
									...
									h("td", { style: Object.assign({}, S.usageTd, { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }), title: fmtLastUpd(sources && sources.lastUpdated ? sources.lastUpdated["cc-switch"] : null) },
		...
		function ModelPricingPanel() {
			...
			var editableRows = function () {
				...
				rows2.push(h("tr", { key: "__new" },
					h("td", { style: td }, h("input", { style: fill, placeholder: t("settings.pricing.namePlaceholder"), value: draft.model, onChange: function (e) { patch("model", e.target.value); } })),
									...
									fetch("/token-monitor/upgrade", { method: "POST" })
										...
										.then(function (d) {
											if (d && d.ok) {
												...
												setUpgradeResult({ ok: true, text: d.restartRequired ? t("settings.version.ok") : t("settings.version.ok") });
											} else if (d && d.error) {
