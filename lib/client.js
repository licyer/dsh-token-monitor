	...
	factory: (require) => {
		...
		var DICT = {
			zh: {
				...
				"src.syncRows": "{n} 条",
				"src.syncTip": "最近一次同步：{time} · 导入 {n} 条 · 跳过 {m} 条 · 扫描 {k} 个文件",
				"src.syncNone": "暂无同步记录",
				"src.col.action": "操作",
			...
			en: {
				...
				"src.syncRows": "{n} rows",
				"src.syncTip": "Last sync: {time} · {n} imported · {m} skipped · {k} files scanned",
				"src.syncNone": "No sync record yet",
						...
						h("div", { style: { display: "flex", alignItems: "center", gap: "2px" } },
							...
							h("tbody", null,
								h("tr", null,
									...
									h("td", { style: Object.assign({}, S.usageTd, { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }), title: syncTip(sources && sources.lastSync ? sources.lastSync["dsh-logs"] : null) },
								...
								h("tr", null,
									...
									h("td", { style: Object.assign({}, S.usageTd, { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }), title: syncTip(sources && sources.lastSync ? sources.lastSync["cc-switch"] : null) },
		...
		/** "最近同步"列悬浮：时间 + 导入/跳过/扫描文件的完整信息。 */
		function syncTip(x) {
			if (!x) return t("src.syncNone");
			return t("src.syncTip", { time: fmtLastUpd(x.at), n: x.imported, m: x.skipped, k: x.files });
		}
