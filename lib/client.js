	...
	factory: (require) => {
		...
		var DICT = {
			zh: {
				...
				"settings.pricing.namePlaceholder": "模型 id（如 deepseek-v4-flash）",
			...
			en: {
				...
				"settings.pricing.namePlaceholder": "model id (e.g. deepseek-v4-flash)",
						...
						? h("div", { style: Object.assign({}, S.filterMenu, { left: 0, top: "calc(100% + 4px)", zIndex: 130, minWidth: "0", padding: "6px", maxHeight: "none", overflow: "visible", width: "auto" }) },
							h("div", { style: { display: "flex", flexDirection: "column", gap: "6px" } },
								ws.length
									...
									: noPeak,
								h("div", { style: { display: "flex", alignItems: "center", gap: "4px", borderTop: "1px solid var(--dsw-alias-border-l2)", paddingTop: "5px" } },
									h(FilterSelect, {
										options: DAYS,
										value: addDays,
										minWidth: "84px",
			...
			return h("div", { style: S.usageCard },
				h("div", {
					...
					(!draft || draft.editing)
						...
						: h("button", {
							type: "button", style: S.windowBtn,
							onClick: function (e) { e.stopPropagation(); beginEdit(null); },
